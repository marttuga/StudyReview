...
```git
git reset abc1234  # Reseta o estado do repositório para o commit com o hash abc1234 (as mudanças após esse commit são removidas do histórico, mas permanecem no diretório de trabalho)
```
