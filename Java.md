...
concatTxt = txt1 + txt2; -  Retorna "Hello World"

concatTxtMethod = txt1.concat(txt2);   -  Retorna "Hello World"
...
### Listas
As listas são coleções ordenadas de elementos. Cada elemento em uma lista tem uma posição específica, conhecida como índice.
...
As árvores são estruturas de dados hierárquicas que consistem em nós conectados por arestas. Cada nó possui um valor e zero ou mais nós filhos.
...
Grafos são estruturas de dados que consistem em um conjunto de vértices (ou nós) conectados por arestas. Os grafos podem ser direcionados ou não direcionados.
